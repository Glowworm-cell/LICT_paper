...
markers = readRDS('../../LLMsCellType/240616gc_different_method5/gc_markers.rds')
####loading package
library(LICT)
...
#save result
saveRDS(LLMCelltype_res,'./gc_LLMCelltype_res.rds')
LLMCelltype_res = readRDS('./gc_LLMCelltype_res.rds')
...
##del
Reliable_Df = readRDS('./gc_Reliable_Df.rds')
##
Reliable_Df
##del
Validate_res = readRDS('./gc_Validate_res.rds')
##
