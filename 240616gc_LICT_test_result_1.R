setwd('D:/R/LLMsCellType/240616gc_different_method4/')
...
markerdata <- data_frame(
  Row = c(2, 3, 5, 8, 11),
  Marker_Gene = c(
    "GIF, ATP4B, SST, PGC, MUC6, MUC5AC, LYZ, TFF2, GHRL, GKN1, GKN2, PDX1, MIST1, BHLHA15, MUC1, EPCAM, CDH1, KRT18, KRT8, KRT19, OCLN, TJP1, DSP, CLDN7, CLDN1, ITGA6, ITGB4, CD24, SNAI1, SNAI2, MUC5AC, TFF1, TFF2, PGA5, MUC1, MUC6, GAST, LYZ, PGC, AQP5, CDH17, VIL1, CXCL8, REG4, LTF, TFF1, MUC5AC, GAST, PGA5, PGC, LYZ, CLDN18, AQP4, CDH17, MUC1, MUC6, GHRL, ITLN1, KRT20, HNF4A",
    "NCR1, KIR2DL1, KIR2DL3, KIR2DL4, KIR3DL1, KIR3DL2, KIR3DL3, CD16, CD56, CD57, GZMB, PRF1, KLRD1, KLRC1, KLRF1",
    "CD4, IL2RA, IL7R, CCR7, SELL, CD40LG, IL4, IL5, IL13, IL17A, FOXP3, GATA3, TBX21, RORC, CTLA4, CD3D, CD3E, CD3G, CD2, CD5, CD7, CD28, CD6, IL7R, TRAC, TRBC1, TRBC2, TRGC1, TRGC2, TRDC, CXCR5, PD1, BCL6, SH2D1A, IL21, SAP, ICOS, CD40LG, CD84, IL6ST, BATF, CD200, CD278, IL4, CXCL13, CCR7, CD45RA, SELL, TCF7, LEF1, IL7R, CD2, CD5, CD28, CD27, CD62L, BCL11B, LCK, ZAP70, CD3E",
    "ACTA2, MYH11, TAGLN, CNN1, CALD1, MYLK, TPM2, SM22, LMOD1, ACTG2, MYL9, SMTN, VIM, DES, TPM1",
    "CD19, CD20, CD79A, CD79B, CD22, CD21, MS4A1, CD38, CD24, CD27, BANK1, BCL6, MALT1, CD40, PAX5"
  )
)

table(markerdata$Row == cluster)
...
inter_res_1 = LLM_interect(positive_gene = list(
  ...
  row9 = c('PMP22','LGI4','FXYD1','GFRA3','SPARC','PCSK2','MPZ','L1CAM','CLU','PRNP','PMP22','S100B','PLP1','CDH19')),
  negative_gene = list(
    row1 = c(),
    row2 = c(),
    row3 = c('NCR1','KIR2DL1','KIR2DL3','KIR2DL4','KIR3DL1','KIR3DL2','KIR3DL3','PRF1','KLRC1','KLRF1'),
    row4 = c(),
    row5 = c('CD4','IL2RA','IL7R','CCR7','SELL','CD40LG','IL4','IL5','IL13','IL17A','FOXP3','GATA3','TBX21','RORC','CTLA4','CD3E','CD3G','CD2','CD5','CD7','CD28','CD6','IL7R','TRAC','TRBC1','TRBC2','TRGC1','TRGC2','CXCR5','BCL6','SH2D1A','IL21','ICOS','CD84','IL6ST','BATF','CD200','IL4','CXCL13'),
    row6 = c(),
    row7 = c(),
    row8 = c('MYH11','CNN1','MYLK','LMOD1','ACTG2','SMTN','DES'),
    row9 = c('MAP2','SYP','GAP43','NEFH','NEFM','TUBB3','SNAP25','CAMK2A','SYN1','VAMP2','ENO2','GFAP','SLC12A5','MPZ','MBP','NGFR','L1CAM','SOX10','ERBB3','NKX2.2','CNP','GALC')))
