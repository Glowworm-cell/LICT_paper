setwd('D:/R/LLMsCellType/240615pbmc_different_method6/')
...
inter_res_1 = LLM_interect(positive_gene = list(
  ...
  row3 = c(),
  row4 = c(),
  row5 = c('FGFBP2','GNLY','CTSW','GZMB','PRF1','CD8A','CD2'),
  row6 = c('HMOX1','SIGLEC10','CTSL','C1QA','LST1','CD68','CSF1R','FCGR3A','S100A9','LYZ'),
  row7 = c('IGHD','IGLC3','LINC00926','CD22','TCF4','MS4A1','CD79A','CD79B','BANK1'),
  row8 = c('LINC00861','NOSIP','OXNAD1','CAMK4','BCL11B','CD3D','CD3E','CD3G','SELL','IL7R'),
  row9 = c('CD2','MAF','KLRG1','C12orf75','TGFBR3'),
  row10 = c('VPREB3','CD22','TNFRSF13C','IGLC2','FCER2','MS4A1','CD79A','CD79B','BANK1'),
  row11 = c('TRGC2','LYAR','CD69','CCL5','MYBL1'),
  row12 = c('GZMA','GZMH','DUSP2','GZMK','CTSW'),
  row13 = c('GPR171','TCF7','CLDND1','RCAN3','CD3D','CD3D','CD3E','CD3G'),
  row14 = c('TIGIT','MYB','TTN','LEF1','SESN3','CD3E','CD3D'),
  row15 = c('AIM2','LINC00926','VPREB3','CD79B','JCHAIN','MS4A1','CD79A','CD79B'),
  row16 = c('TCF7L2','HES4','RGS18','IFITM3','CFD','S100A8','S100A9'),
  row17 = c(),
  row18 = c('PTTG1','CENPF','SMC2','NUSAP1','CHEK1','PRF1','CD3E','CD3D','CD2'),
  row19 = c(),
  row20 = c('TXNDC5','SEC11C','IGLC3','PDIA4','CD38','MZB1','JCHAIN','CD79A','CD38','PRDM1','CD27'),
  row21 = c('CD40LG','SYNE2','PDE4D','LTB','DPP4','CD3D','CD3E','CD3G'),
  row22 = c('HLA-DMB','LGALS2','HLA-DPB1','CST3','PLD4','PTPRC','CD1C','S100A9'),
  row23 = c('HELLS','RRM2','ATAD2','MCM4','TPX2','GZMB','PRF1'),
  row24 = c('IRF8','CCDC50','SCT','SOX4','DAB2','CLEC4C'),
  row25 = c('EGFL7','GATA2','STMN1','NPR3','CD34'),
  row26 = c(),
  row27 = c('NCAM1','TRDC','CTSW','SPTSSB','HOPX','PRF1'),
  row28 = c('TPX2','BIRC5','TK1','HMMR','CLSPN','CD3E','CD3D','CD2'),
  row29 = c(),
  row30 = c('SHTN1','BASP1','CPVL','FLT3','TSPAN33','PTPRC')),
  negative_gene = list(
    row1 = c('FCGR3A','CCR2','ITGAM','FCGR3A','CSF1R','MPO','ELANE','FCGR1A','CXCR2'),
    row2 = c('CD5','CD7','CD28','CD6','TRBC1','MS4A1','CD19','MS4A1','SELL'),
    row3 = c(),
    row4 = c(),
    row5 = c('CD8B','GZMB','PRF1','KLRD1','KLRB1','KLRC1','KIR3DL1','KIR2DL1','FCGR3A','CD7'),
    row6 = c('FCGR1A','CCR2','S100A8','ITGAM','CD33','CXCR4','CD86','CD36'),
    row7 = c('CD19','CD22','CD24','PAX5','BLNK','BTK','MALT1','CD40','CD38'),
    row8 = c('CD4','CD28','CD40LG','CCR7','CD5'),
    row9 = c('NCAM1','KIR2DL1','KIR3DL1','FCGR3A','CD7'),
    row10 = c('CD19','CD22','CD24','PAX5','BLNK','BTK','MALT1','CD40','CD38'),
    row11 = c('NCAM1','FCGR3A','KIR2DL1','KIR3DL1','CD7','CD2','CD8A'),
    row12 = c(''),
    row13 = c('CD8A','CD8B','GZMB','PRF1','CD28','CD27','CTLA4','CCR5'),
    row14 = c('CD4','CXCR5','BCL6','CD40LG','ICOS','CD28','FCGR3A'),
    row15 = c('CD19','CD38','POU5F1','MZB1','JCHAIN','IRF4','CD27','PAX5'),
    row16 = c('PF4','CD14','FCGR3A','FCGR1A','MZB1'),
    row17 = c(),
    row18 = c('CD4','GZMB','CD40LG','ICOS','CD28','CXCR3','CCR5','CD27'),
    row19 = c(),
    row20 = c('SDC1','POU5F1','IRF4','SDC1','PAX5'),
    row21 = c('NCAM1','CXCR5','BCL6','CD40LG','ICOS','KIR2DL1','KIR3DL1','CD4'),
    row22 = c('CLEC4C','CD207','FSCN1','CD40','CD80','CD86'),
    row23 = c('CD4','CD40LG','ICOS','CD28','CD3E','CD3D','CD2','CXCR3','CCR5','CD27'),
    row24 = c('CD4','GZMB','CD40LG','MZB1','JCHAIN'),
    row25 = c(''),
    row26 = c(),
    row27 = c('NCAM1','KIR2DL1','KIR3DL1','FCGR3A','GZMB','CD8A'),
    row28 = c('CD4','GZMB','PRF1','CD40LG','ICOS','CD28','CXCR3','CCR5','CD27'),
    row29 = c(),
    row30 = c('CLEC4C','CD1C','FSCN1','CD40','CD80','CD86','CD83','S100A9')))

inter_res_1_C = Claude_interact(positive_gene = list(
  row1 = c('CD36','SERPINA1','AC020656.1','MPEG1','FPR1','CD14','S100A8','S100A9','LYZ','FCN1'),
  row2 = c('CD40LG','TNFRSF4','TRADD','RCAN3','TNFRSF25','CD3D','CD3E','CD3G','CD2','TRAC','TRBC2'),
  row3 = c(),
  row4 = c(),
...
E = c('1: Neutrophil\n2: Activated T cell\n3: Cytotoxic T cell\n4: Natural Killer cell\n5: NK cell\n6: Macrophage\n7: Mature B cell\n8: Central memory T cell\n9: NK cell\n10: Mature B cell\n11: Gamma delta T cell\n12: Gamma delta T cell\n13: Naive T cell\n14: Naive T cell\n15: B cell\n16: Monocyte\n17: Plasmacytoid dendritic cell\n18: Cycling T cell\n19: Regulatory T cell\n20: Plasma cell\n21: Naive T cell\n22: Myeloid dendritic cell\n23: Cycling T cell\n24: Conventional dendritic cell\n25: Hematopoietic stem cell\n26: Platelet\n27: Gamma delta T cell\n28: Cycling T cell\n29: Erythrocyte\n30: Dendritic cell\n31: Treg cell')
rows <- strsplit(E, "\n")[[1]]
