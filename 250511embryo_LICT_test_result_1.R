...
seurat_obj = readRDS('D:/R/wb_2/human/human embryo.rds')
...
#save result
saveRDS(interacted_res,'./interacted_res2.rds')
##
...
res = readRDS('./interacted_res.rds')
