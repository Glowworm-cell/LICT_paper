setwd('D:/R/LLMsCellType/240616gc_different_method5/')
devtools::install_github('Glowworm-cell/LICT')
detach(package:LICT, unload=TRUE)
...
inter_res_1 = LLM_interect(positive_gene = list(
  ...
  negative_gene = list(
    ...
    row4 = c(),
    row5 = c('CD3E','CD3G','CD2','CD5','CD7','CD28','CD6','IL7R','TRAC','TRBC1','TRBC2','TRGC1','TRGC2','TRDC','CXCR5','BCL6','SH2D1A','IL21','ICOS','CD40LG','CD84','IL6ST','BATF','CD200','IL4','CXCL13','CCR7','SELL','TCF7','LEF1','CD27','BCL11B','LCK','ZAP70'),
    row6 = c(),
    row7 = c(),
    row8 = c('MYH11','CNN1','MYLK','LMOD1','ACTG2','SMTN','DES')))
C = c( "1: Plasma cells\n2: Gastric epithelial cells\n3: CD8+ T cells\n4: CD8+ T cells\n5: CD4+ T cells\n6: Macrophages\n7: Fibroblasts\n8: Pericytes\n9: Glial cells\n10: Endothelial cells\n11: B cells\n12: Mast cells")
rows <- strsplit(C, "\n")[[1]]
