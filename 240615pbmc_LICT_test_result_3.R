setwd('D:/R/LLMsCellType/240615pbmc_different_method5/')
...
pbmc_res_G = GeminiCellType(input = markers,
                            species = 'human',
                            topgenenumber = 10,
                            tissuename = 'peripheral blood mononuclear cell')
pbmc_res[['Gemini']] = pbmc_res_G
res = pbmc_res
...
inter_res_1 = LLM_interect(positive_gene = list(
  ...
  row3 = c(),
  row4 = c(),
  row5 = c('FGFBP2','GNLY','CTSW','GZMB','PRF1'),
  row6 = c('HMOX1','SIGLEC10','CTSL','C1QA','LST1','FCGR3A','CSF1R','FCGR3A','S100A9','LYZ'),
  ...
  row11 = c('TRGC2','LYAR','CD69','CCL5','MYBL1','CD3E','CD3D'),
  row12 = c('GZMA','GZMH','DUSP2','GZMK','CTSW'),
  row13 = c('GPR171','TCF7','CLDND1','RCAN3','CD3D','CD3D','CD3E','CD3G'),
  row14 = c('TIGIT','MYB','TTN','LEF1','SESN3','PTPRC'),
  row15 = c('AIM2','LINC00926','VPREB3','CD79B','JCHAIN','MS4A1','CD79A','CD79B'),
  row16 = c('TCF7L2','HES4','RGS18','IFITM3','CFD','S100A8','S100A9'),
  row17 = c(),
  row18 = c('PTTG1','CENPF','SMC2','NUSAP1','CHEK1','VIM','ITGB1'),
  row19 = c(),
  row20 = c('TXNDC5','SEC11C','IGLC3','PDIA4','CD38','MZB1','JCHAIN','CD79A','CD38','PRDM1','CD27'),
  row21 = c('CD40LG','SYNE2','PDE4D','LTB','DPP4','CD3E'),
  row22 = c('HLA-DMB','LGALS2','HLA-DPB1','CST3','PLD4','PTPRC','CD1C'),
  row23 = c('HELLS','RRM2','ATAD2','MCM4','TPX2','VIM','ITGB1'),
  row24 = c('IRF8','CCDC50','SCT','SOX4','DAB2','PTPRC','CLEC4C'),
  row25 = c('EGFL7','GATA2','STMN1','NPR3','CD34'),
  row26 = c(),
  row27 = c('NCAM1','TRDC','CTSW','SPTSSB','HOPX','CD2','CD7'),
  row28 = c('TPX2','BIRC5','TK1','HMMR','CLSPN','VIM'),
  row29 = c(),
  ...
  negative_gene = list(
    ...
    row4 = c(),
    row5 = c(''),
    row6 = c('CD14','CCR2','S100A8','ITGAM','CD33','CXCR4','CD86','CD36'),
    row7 = c('CD19','CD22','CD24','PAX5','BLNK','BTK','MALT1','CD40','CD38'),
    row8 = c('CD4','CD8A','CCR7','CD5','CD28','CD2','CD6'),
    row9 = c('NCAM1','KIR2DL1','KIR3DL1','GZMB','PRF1','FCGR3A','CD8A','CCR7','CD27','CD28','CTLA4','CD44'),
    row10 = c('CD19','CD22','CD24','PAX5','BLNK','BTK','MALT1','CD40','CD38'),
    row11 = c('NCAM1','CD2','CD5','CD7','KIR2DL1','KIR3DL1','FCGR3A','GZMB','PRF1'),
    row12 = c(''),
    row13 = c('CD4','CD8A','CD28','CTLA4','GZMB','PRF1','CCR7','SELL'),
    row14 = c('NCAM1','CD27','MS4A1','MS4A1','CD79B','CD4','FCGR3A','GZMB'),
    row15 = c('CD19','CD38','POU5F1','MZB1','JCHAIN','IRF4','CD27','PAX5'),
    row16 = c('PF4','CD14','FCGR3A','FCGR1A','MZB1'),
    row17 = c(),
    row18 = c('CD44','CD200','ITGA6'),
    row19 = c(),
    row20 = c('SDC1','POU5F1','IRF4','SDC1','PAX5'),
    row21 = c('NCAM1','CD8A','SELL','CCR7','CD27','CD28','KIR2DL1','KIR3DL1','FCGR3A'),
    row22 = c('CLEC4C','CD207','FSCN1','CD40','CD80','CD86','CD83','CCR7'),
    row23 = c('LAMA5','CD44','NGFR','CD34','LIF','NGFR','FGF7','ITGA6'),
    row24 = c('CD1C','FSCN1','MZB1','JCHAIN'),
    row25 = c(''),
    row26 = c(),
    row27 = c('NCAM1','KIR2DL1','KIR3DL1','FCGR3A','CD3E','CD3D','CD5'),
    row28 = c('CD44','LIF','ITGA6','ITGB1'),
    row29 = c(),
    row30 = c('CLEC4C','CD1C','FSCN1','CD40','CD80','CD86','CD83','CCR7')))
